...
## Testing
- 4 language implementations (Go, Rust, Python, TS) must pass tests before publishing.
...
- **NaN/Inf policy**: allowed in cowrie binary encoding, rejected in the JSON bridge.
