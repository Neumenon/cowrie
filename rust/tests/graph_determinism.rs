...
// Canonical COWR/v1 output (header "COWR" + version 0x01 + flags 0x00). The body bytes are
// byte-identical to the pre-migration SJ/v2 ground truth; only the 4-byte header changed.
const GO_NODE: &str =
    "434f575201000203616765046e616d6535026e310106506572736f6e02005e010505416c696365";

const GO_EDGE: &str = "434f57520100020573696e6365067765696768743601610162054b4e4f5753020003c81f0145";

const GO_NODE_BATCH: &str =
    "434f575201000203616765046e616d653701026e310106506572736f6e02005e010505416c696365";

const GO_EDGE_BATCH: &str =
    "434f57520100020573696e636506776569676874380101610162054b4e4f5753020003c81f0145";
